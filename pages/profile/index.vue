        ...
        <section v-else>
            <main v-if="editMode">
                ...
                <div>
                    ...
                    <input v-model="user.username" type="text" id="username" :disabled="!editMode" />
                </div>
                <div>
                    <label for="email">Email</label>
                    <input v-model="user.email" type="email" id="email" :disabled="!editMode" />
                </div>
                <div>
                    <label for="birthdate">Birthdate</label>
                    <input v-model="user.birthdate" type="date" id="birthdate" :disabled="!editMode" />
                </div>
                <div>
